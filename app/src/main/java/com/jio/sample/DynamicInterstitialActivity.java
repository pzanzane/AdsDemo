...
public class DynamicInterstitialActivity extends BaseActivity  {
    ...
    private void dynamicInterstitialAd() {
        dialog.show();
        jioAdView = new JioAdView(this, "xlfgmn7s",
        ...
        jioAdView.setAdListener(new JioAdListener() {
            ...
            public void onAdRender(@Nullable JioAdView jioAdView) {
                Toast.makeText(DynamicInterstitialActivity.this, "onAdRender : " , Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onAdMediaEnd(@Nullable JioAdView jioAdView) {
                Toast.makeText(DynamicInterstitialActivity.this, "onAdMediaEnd : " , Toast.LENGTH_SHORT).show();
            }
        });
